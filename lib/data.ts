...
export const dataList: WebNavigationListRow[] = [
  {
    ...
    name: 'Pokemon',
    title: 'Pokemon Infinite Fusion - Fan-made Game with Hybrid Pokemon, ROM Download, and Discord',
    content: 'Pokemon Infinite Fusion - Fan-made Game with Hybrid Pokemon, ROM Download, and Discord',
    url: 'https://pokemoninfinitefusion.net/',
    imageUrl: 'https://img.tap4.ai/tools/2024/7/4/pokemoninfinitefusion-net-1720063989.png',
    thumbnailUrl: 'https://img.tap4.ai/tools/2024/7/4/pokemoninfinitefusion-net-thumbnail-1720063995.png',
  },
  {
    id: '1791374430986211330',
    name: 'PokemonUranium',
    title: 'Pokemon Uranium - Official Site',
    content:
      'Pokemonuranium.co: Explore the official website for the beloved fan-made game Pokemon Uranium, featuring a dedicated forum for fans',
    url: 'https://pokemonuranium.co/',
    imageUrl: 'https://img.tap4.ai/tools/2024/7/4/pokemonuranium-co-1720072149.png',
    thumbnailUrl: 'https://img.tap4.ai/tools/2024/7/4/pokemonuranium-co-thumbnail-1720072151.png',
  },
  {
    id: '1791374430986211332',
    name: 'PokemonInsurgence',
    title: 'Pokemon Insurgence - Unleash the Power of Pokemon in a New Adventure',
    content:
      'P-insurgence.com: Pokemon Insurgence is a fan-made game set in a unique region, featuring exciting elements like Delta Pokemon, Armored Pokemon, Secret Bases, Online Trading, and Character customization. Discover a new world of Pokemon adventures!',
    url: 'https://p-insurgence.com/',
    imageUrl: 'https://img.tap4.ai/tools/2024/7/4/p-insurgence-com-1720074130.png',
    thumbnailUrl: 'https://img.tap4.ai/tools/2024/7/4/p-insurgence-com-thumbnail-1720074134.png',
  },
  {
    id: '1791374430986211334',
    name: 'pokeharbor',
    title: 'PokéHarbor - Best Pokemon ROM Hacks, FanGames, Cheats & Guides',
    content:
      'Pokeharbor.com: Download the latest Pokemon GBA, NDS, GBC Rom Hacks & RPGXP Fan Games for free at PokéHarbor. All games are pre-patched, and the site also provides cheat codes, walkthroughs, and guides.',
    url: 'https://www.pokeharbor.com/',
    imageUrl: 'https://img.tap4.ai/tools/2024/7/4/pokeharbor-com-1720075640.png',
    thumbnailUrl: 'https://img.tap4.ai/tools/2024/7/4/pokeharbor-com-thumbnail-1720075643.png',
  },
  {
    id: '1791374430986211336',
    name: 'pokemondb-net-platinum',
    title: 'Pokémon Platinum Database | Pokédex Stats Information Sword & Shield',
    content:
      'Pokemondb.net: Explore the ultimate Pokemon database for Platinum version released in 2009. Find detailed information on gym leaders, Elite 4 Pokemon, stats, and more for Sword & Shield.',
    url: 'https://pokemondb.net/platinum',
    imageUrl: 'https://img.tap4.ai/tools/2024/7/5/pokemondb-net-platinum-1720144335.png',
    thumbnailUrl: 'https://img.tap4.ai/tools/2024/7/5/pokemondb-net-platinum-thumbnail-1720144338.png',
  },
];
...
export const detailList: WebNavigationDetailData[] = [
  {
    ...
    title: 'Pokemon Infinite Fusion - Fan-made Game with Hybrid Pokemon, ROM Download, and Discord',
    detail:
      "### What is PokéRogue?\nPokéRogue is a thrilling Pokémon rogue-lite game where players can immerse themselves in the world of PokéRogue. With exciting adventures, turn-based combat systems, and a variety of Pokémon to collect and evolve, players can embark on a journey to build the ultimate team and challenge powerful bosses.\n\n### How to Start Playing PokéRogue?\nTo start playing PokéRogue, players can experience the exhilarating thrill of acquiring Pokémon eggs through the PokéRogue's egg gacha feature. By collecting and hatching various Pokémon eggs, players can build their dream team and dive into the captivating world of PokéRogue.\n\n### Key Features of PokéRogue:\n- Turn-Based Combat System: Enjoy the beloved turn-based combat mechanics that engage players in strategic battles with wild Pokémon encounters.\n- Pokémon Dex Completion: Capture a wide range of Pokémon, add them to your collection using Poké Balls, and complete your Pokémon Dex for an immersive journey.\n- Infinite Pokémon Upgrades: Discover a world of infinite Pokémon upgrades in PokéRogue, where you can experience new evolutions, abilities, and combat scenarios.\n\n### Pricing and Subscription Options:\n- Free-to-Play: PokéRogue offers a free-to-play model for players to start their Pokémon adventure without any initial cost.\n- In-Game Purchases: Players can access in-game shop items to heal their Pokémon during battles, with prices calculated based on the current in-game economy.\n\n### Game Modes:\nPokéRogue features various game modes such as Classic, Daily Run, Infinite, and Split Infinite, providing diverse gameplay experiences for players.\n\n### Additional Information:\nFor more details and updates on PokéRogue, including special evolution methods, game modes, and frequently asked questions, players can explore the dynamic world of PokéRogue and prepare for an exciting journey ahead. Start your adventure for free and join the global PokéRogue community today!",
    content:
      'Pokemoninfinitefusion.net: Pokemon Infinite Fusion - Official Game Website. Download the latest version for Windows and Android. Combine and play with hybrid Pokemon. Find ROMs, sprites, wiki, fandom, and more. Join the Discord community for game updates and support.',
    url: 'https://pokemoninfinitefusion.net/',
    imageUrl: 'https://img.tap4.ai/tools/2024/7/4/pokemoninfinitefusion-net-1720063989.png',
    thumbnailUrl: 'https://img.tap4.ai/tools/2024/7/4/pokemoninfinitefusion-net-thumbnail-1720063995.png',
  ...
  },
  {
    ...
    title: 'Pokemon Uranium - Official Site',
    detail:
      '### What is Pokemon Uranium?\nPokemon Uranium is a fan game set in a new region, featuring over 150 original Pokemon, a unique Nuclear Type, Nuzlocke gameplay, and much more.\n\n### How to Play Pokemon Uranium?\nTo play Pokemon Uranium, you can visit the official website at [Pokemon Uranium](https://pokemonuranium.co/) and explore the game. You can also engage with the Pokemon Uranium community on various platforms such as the forum, Reddit, Twitter, Discord, and Wiki.\n\n### Key Features of Pokemon Uranium:\n- Over 150 original Pokemon to discover and catch\n- Introduction of the Nuclear Type for a new gameplay experience\n- Nuzlocke gameplay mode for added challenge and excitement\n- Active community on various platforms for discussions and support\n\n### Pricing for Pokemon Uranium:\nPokemon Uranium is available for free to all players. Simply visit the official website to download and start playing the game without any cost. Join the Pokemon Uranium community today and embark on a new Pokemon adventure in this fan-made game.',
    content:
      'Pokemonuranium.co: Explore the official website for the beloved fan-made game Pokemon Uranium, featuring a dedicated forum for fans.',
    url: 'https://pokemonuranium.co/',
    imageUrl: 'https://img.tap4.ai/tools/2024/7/4/pokemonuranium-co-1720072149.png',
  ...
  },
  {
    ...
    title: 'Pokemon Insurgence - Unleash the Power of Pokemon in a New Adventure',
    detail:
      '### What is Pokemon Insurgence?\nPokemon Insurgence is a fangame for the Pokemon series based in a brand new region called Torren. It introduces unique mechanics such as Delta Pokemon, Armored Pokemon, Secret Bases, Online Trading, and Character customization.\n\n### How can I get involved in the Pokemon Insurgence community?\nYou can start by posting on the forums or joining the Discord server to chat with other fans and developers.\n\n### Key Features of Pokemon Insurgence:\n- A new region and story: Experience an exciting plot in the region of Torren and decide the fate of the region.\n- Delta Species: Discover a new variant of Pokemon that provides a fresh perspective on familiar creatures.\n- New Mega Evolutions: Uncover new mega evolutions with unique megastones designed to enhance your team.\n- Online Features: Trade with friends, visit secret bases, and engage in online interactions to enrich your gameplay experience.\n- Additional Features:\n  - Handcrafted difficulty levels to suit your playstyle.\n  - Various Challenge Modes like Nuzlocke, Solo Run, and more.\n  - Character customization options including clothes, hairstyles, and accessories.\n  - Catch Pokemon up to the 6th Generation.\n  - Create and customize your secret base with obstacles and challenges.\n  - Introduce never-before-seen Mega Evolutions.\n  - New type of Held-Item called Armors for enhanced defenses.\n  - Use HM items without the need for Pokemon with specific HMs.\n  - Extensive endgame content with quests and exploration opportunities.\n\n### Downloads for Pokemon Insurgence:\n- Current Version: 1.2.7\n- Windows:\n  - Installer: Recommended for easy installation.\n  - Full Download and Patch Only options available.\n- Mac: Guide provided for installation.\n\n### Meet the Developers of Pokemon Insurgence:\n- Lead Developer: 1ofthe4rocketbros\n- Server Programmer: Deukhoofd\n- Previous Developers & Helpers: TheSuzerain, SleepLate, MrSinger186, EchoTheThird, AtlusAbound, ZeroBreaker, Demonknight, Sleepymon12, FluffyChikorita, Skurleton, Nico, Rune_Script, Selena\n\nCopyright 2022 Deukhoofd & EchoTheThird | Free Web Navigation Icon Pack by Freepik | All Rights Reserved',
  ...
  {
    name: 'pokeharbor',
    title: ' PokéHarbor - Best Pokemon ROM Hacks, FanGames, Cheats & Guide',
    detail:
      '### What is PokéHarbor?\nPokéHarbor is a platform dedicated to Pokemon ROM Hacks, FanGames, Cheats, and Guides, offering a wide range of content for Pokemon enthusiasts.\n\n### How to Navigate PokéHarbor?\nUsers can explore various categories such as ROM Hacks, Cheats, Guides, and Emulators across different Pokemon series and generations like GBA, NDS, GBC, and more.\n\n### Key Features of PokéHarbor:\n- Extensive collection of ROM Hacks for different Pokemon games and platforms.\n- In-depth guides and cheats to enhance the gaming experience.\n- Regular updates on new releases, events, and trending topics in the Pokemon community.\n\n### Pricing at PokéHarbor:\nPokéHarbor provides all its content for free, allowing users to access a wealth of Pokemon-related resources without any subscription fees.',
    content:
      'Pokeharbor.com: Download the latest Pokemon GBA, NDS, GBC Rom Hacks & RPGXP Fan Games for free at PokéHarbor. All games are pre-patched, and the site also provides cheat codes, walkthroughs, and guides.',
